...
const fr = {
  ...
  'faq.4.a': 'Choisissez une date dans le calendrier de réservation, on confirme par email sous 24 h. Nous couvrons tout le Grand-Duché depuis Strassen.',
...
const de: FullDict = {
  ...
  'faq.4.a': 'Wählen Sie ein Datum im Buchungskalender, wir bestätigen per E-Mail innerhalb von 24 Std. Von Strassen aus decken wir das ganze Großherzogtum ab.',
  ...
  'book.time': 'Uhrzeit',
  'book.duration': 'Geschätzte Dauer',
  'book.ends': 'Ende ca.',
  'book.address': 'Adresse',
...
const en: FullDict = {
  ...
  'faq.4.a': 'Pick a date in the booking calendar and we confirm by email within 24 hours. We cover the whole Grand Duchy from Strassen.',
  ...
  'book.time': 'Time',
  'book.duration': 'Estimated duration',
  'book.ends': 'ends around',
...
const pt: PartialDict = {
  ...
  'faq.4.a': 'Escolha uma data no calendário de reserva e confirmamos por email em 24 h. Cobrimos todo o Grão-Ducado a partir de Strassen.',
  ...
  'book.time': 'Hora',
  'book.duration': 'Duração estimada',
  'book.ends': 'fim por volta das',
  'book.address': 'Morada',
...
const es: PartialDict = {
  ...
  'faq.4.a': 'Elige una fecha en el calendario de reserva y confirmamos por email en 24 h. Cubrimos todo el Gran Ducado desde Strassen.',
  ...
  'book.time': 'Hora',
  'book.duration': 'Duración estimada',
  'book.ends': 'fin hacia las',
