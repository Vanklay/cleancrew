...
const fr = {
  ...
  'home.together.title': 'Un garage vidé. Le reste, impeccable. Une seule équipe.',
  'home.together.text': 'Pendant qu’on est chez vous, on s’occupe aussi des vitres, des façades et des allées. Un seul passage, une équipe qui connaît déjà les lieux et qui revient. Tout l’extérieur de votre propriété, sans coordination ni surprises.',
...
const de: FullDict = {
  ...
  'home.together.title': 'Eine geräumte Garage. Der Rest, makellos. Ein Team.',
  'home.together.text': 'Wenn wir schon bei Ihnen sind, übernehmen wir auch Fenster, Fassaden und Einfahrten. Ein Termin, ein Team, das den Ort bereits kennt und wiederkommt. Der ganze Außenbereich, ohne Koordination und ohne Überraschungen.',
...
const en: FullDict = {
  ...
  'home.together.title': 'A cleared garage. The rest, impeccable. One team.',
  'home.together.text': 'While we’re at your place, we also handle the windows, façades and driveways. One visit, a team that already knows the property and comes back. The whole exterior, with no coordination and no surprises.',
...
const lu: PartialDict = {
  ...
  'home.together.title': 'Eng eidel Garage. De Rescht, propper. Ee Team.',
  'home.together.text': 'Wa mir scho bei Iech sinn, këmmere mir eis och ëm Fënsteren, Fassaden an Afahrten. Een Asaz, en Team dat d’Plaz scho kennt an erëmkënnt. De ganzen Aussebereich, ouni Koordinatioun an ouni Iwwerraschungen.',
...
const pt: PartialDict = {
  ...
  'home.together.title': 'Uma garagem vazia. O resto, impecável. Uma só equipa.',
  'home.together.text': 'Já que estamos na sua casa, tratamos também dos vidros, fachadas e acessos. Uma visita, uma equipa que já conhece o local e regressa. Todo o exterior, sem coordenação e sem surpresas.',
...
const es: PartialDict = {
  ...
  'home.together.title': 'Un garaje vacío. El resto, impecable. Un solo equipo.',
  'home.together.text': 'Ya que estamos en tu casa, nos ocupamos también de cristales, fachadas y accesos. Una visita, un equipo que ya conoce el lugar y vuelve. Todo el exterior, sin coordinación y sin sorpresas.',
