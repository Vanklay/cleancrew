...
const fr = {
  ...
  'faq.3.a': 'Oui — une équipe, un passage. Le débarras nous fait souvent venir, et la même équipe entretient ensuite vitres, façades et allées. Vous ne jonglez jamais avec plusieurs prestataires.',
  ...
  'home.services.lead': 'Le débarras vous fait nous rencontrer. La même équipe garde ensuite vitres et façades impeccables, sans jongler avec trois prestataires.',
  'home.together.title': 'Une seule équipe pour votre garage, vos vitres et vos façades.',
  'home.together.text': 'Au Luxembourg, la plupart de nos clients nous découvrent par un débarras de garage. La même équipe revient ensuite pour le nettoyage des vitres, des façades et des allées : un seul interlocuteur, un seul passage, pour tout l’extérieur de votre propriété. Aucun prestataire à coordonner, aucune surprise — une équipe qui connaît déjà les lieux et un devis clair à chaque intervention.',
...
const de: FullDict = {
  ...
  'faq.3.a': 'Ja — ein Team, ein Termin. Oft kommen wir über die Entrümpelung, und dieselbe Crew pflegt danach Fenster, Fassaden und Einfahrten. Sie jonglieren nie mit mehreren Dienstleistern.',
  ...
  'home.services.lead': 'Über die Entrümpelung lernen uns die meisten kennen. Dasselbe Team hält danach Fenster und Fassaden makellos, ohne drei Dienstleister.',
  'home.together.title': 'Ein Team für Garage, Fenster und Fassaden.',
  'home.together.text': 'In Luxemburg lernen uns die meisten Kunden über eine Garagenentrümpelung kennen. Dasselbe Team kommt danach für die Fenster-, Fassaden- und Einfahrtreinigung: ein Ansprechpartner, ein Termin, für den gesamten Außenbereich Ihrer Immobilie. Kein Dienstleister zu koordinieren, keine Überraschungen — ein Team, das den Ort bereits kennt, und ein klares Angebot bei jeder Ausführung.',
...
const en: FullDict = {
  ...
  'faq.3.a': 'Yes — one team, one visit. Garage clearance often brings us in, and the same crew keeps the windows, façades and driveways up, so you never juggle contractors.',
  ...
  'home.services.lead': 'Clearance is how most people meet us. The same team then keeps the windows and façades impeccable, with no juggling three contractors.',
  'home.together.title': 'One team for your garage, your windows and your façades.',
  'home.together.text': 'In Luxembourg, most clients first meet us through a garage clearance. The same crew then comes back for window, façade and driveway cleaning: one point of contact, one visit, for the whole exterior of your property. No contractors to coordinate, no surprises — a crew that already knows the place and a clear quote every time.',
...
const lu: PartialDict = {
  ...
  'faq.3.a': 'Jo — ee Team, een Asaz. Dacks kommen mir iwwer d’Entrëmpelung, an dat selwecht Team pflegt duerno Fënsteren, Fassaden an Afahrten. Dir jongléiert ni mat verschiddene Prestataire.',
  ...
  'home.services.lead': 'Iwwer d’Entrëmpelung léiere meeschtens d’Leit eis kennen. Dat selwecht Team hält duerno Fënster a Fassaden propper, ouni dräi Prestataire.',
  'home.together.title': 'Ee Team fir Är Garage, Är Fënsteren an Är Fassaden.',
  'home.together.text': 'Zu Lëtzebuerg léiere meeschtens d’Clienten eis iwwer eng Garagenentrëmpelung kennen. Dat selwecht Team kënnt duerno fir d’Fënster-, Fassade- an Afahrtbotzen: een Uspriechpartner, een Asaz, fir de ganzen Aussebereich vun Ärer Immobilie. Kee Prestataire ze koordinéieren, keng Iwwerraschungen — en Team dat d’Plaz scho kennt an e kloren Devis bei all Asaz.',
...
const pt: PartialDict = {
  ...
  'faq.3.a': 'Sim — uma equipa, uma visita. Muitas vezes chegamos pelo esvaziamento, e a mesma equipa mantém depois vidros, fachadas e acessos. Nunca anda com vários prestadores.',
  ...
  'home.services.lead': 'O esvaziamento é como a maioria nos conhece. A mesma equipa mantém depois vidros e fachadas impecáveis, sem três prestadores.',
  'home.together.title': 'Uma só equipa para a garagem, os vidros e as fachadas.',
  'home.together.text': 'No Luxemburgo, a maioria dos clientes conhece-nos por um esvaziamento de garagem. A mesma equipa regressa depois para a limpeza de vidros, fachadas e acessos: um único interlocutor, uma só visita, para todo o exterior da sua propriedade. Nenhum prestador para coordenar, nenhuma surpresa — uma equipa que já conhece o local e um orçamento claro em cada intervenção.',
...
const es: PartialDict = {
  ...
  'faq.3.a': 'Sí — un equipo, una visita. A menudo llegamos por el vaciado, y el mismo equipo mantiene luego cristales, fachadas y accesos. Nunca haces malabares con varios proveedores.',
  ...
  'home.services.lead': 'El vaciado es como la mayoría nos conoce. El mismo equipo mantiene luego cristales y fachadas impecables, sin tres proveedores.',
  'home.together.title': 'Un solo equipo para el garaje, los cristales y las fachadas.',
  'home.together.text': 'En Luxemburgo, la mayoría de los clientes nos conocen por un vaciado de garaje. El mismo equipo vuelve luego para la limpieza de cristales, fachadas y accesos: un único interlocutor, una sola visita, para todo el exterior de tu propiedad. Ningún proveedor que coordinar, ninguna sorpresa — un equipo que ya conoce el lugar y un presupuesto claro en cada intervención.',
